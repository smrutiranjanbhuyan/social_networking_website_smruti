...
>
    ...
    <main>
      ...
      <section class="i pg fh rm ki xn vq gj qp gr hj rp hr">
        ...
        >
          ...
          <form class="sb" action="./server/routs/signin.php" method="POST">
            <div class="wb">
            ...
            <p class="sj hk xj rj ob">
              ...
              <a class="mk" href="signup.php"> Sign Up </a>
            </p>
          </form>
        </div>
      </section>
  ...
  <footer>
    <div class="bb ze ki xn 2xl:ud-px-0">
      ...
      <div class="animate_top">
        <p>&copy; 2025 DevBase. All rights reserved</p>
      </div>
    </div> -->
      <!-- Footer Bottom -->
    </div>
