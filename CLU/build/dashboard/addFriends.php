  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light mb-10 fixed-top">
    ...
    <script type="text/javascript">
      $(document).ready(function() {
        $.ajax({
          url: "../server/routs/fetch_users.php",
          type: "GET",
          dataType: "json",
        ...
        <div class="card">
          <div class="row">
            ...
            <div class="col-md-3 col-sm-3">
              <button class="btn btn-primary btn-follow mb-1 btn-${user.user_id}" id="${user.user_id}">Follow</button>
      ...
      function addFriend() {
        ...
        $.ajax({
          url: "../server/routs/add_friend.php",
          type: "POST",
          dataType: "json",
          data: {
            user_id: userId,
          ...
          success: function(response) {
            if (response.success) {
              ...
              <?php echo $_SESSION['following_count']++; ?>;
            } else {
      ...
      $(document).on('click', '.btn-follow', addFriend);

      // Event listener for unfollow buttons
